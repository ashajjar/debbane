<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,docx,doc,xls,xlsx,pdf";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,docx,doc,xls,xlsx,pdf";
